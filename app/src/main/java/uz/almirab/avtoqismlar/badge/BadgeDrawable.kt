package uz.almirab.avtoqismlar.badge
...
class BadgeDrawable(context: Context) : Drawable() {
    ...
    init {
        // mTextSize = 10dp;
        mTextSize = context.resources.getDimension(R.dimen.text_8sp)
    ...
    override fun draw(canvas: Canvas) {
        ...
        val radius = (Math.min(width, height) / 2 - 1) / 1.2.toFloat()
        val centerX = width + radius - 15f
        val centerY = radius - 7
